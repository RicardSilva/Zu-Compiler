// $Id: basic_ast_visitor.h,v 1.14 2016/03/17 18:46:41 ist179027 Exp $ -*- c++ -*-
...
public:
  virtual void do_fundecl_node(zu::fundecl_node * const node, int lvl) = 0;
  virtual void do_fundef_node(zu::fundef_node * const node, int lvl) = 0;
  virtual void do_funcall_node(zu::funcall_node * const node, int lvl) = 0;
  virtual void do_vardecl_node(zu::vardecl_node * const node, int lvl) = 0;
  virtual void do_vardef_node(zu::vardef_node * const node, int lvl) = 0;
