%{
// $Id: zu_parser.y,v 1.9 2016/03/17 17:56:54 ist178414 Exp $
...
%token tIF tPRINT tREAD tBEGIN tEND tFOR
...
stmt : expr ';'                                         { $$ = new zu::evaluation_node(LINE, $1); }
 	   | tPRINT expr ';'                                  { /*FIXME: $$ = new zu::print_node(LINE, $2);*/ }
...
lval : tIDENTIFIER             { /*FIXME: $$ = new zu::lvalue_node(LINE, $1);*/ }
     ;
